...
if __name__ == "__main__":
    ...
    for row in X_test: 
        ...
        qfie.build_inference_qc(input_values, draw_qc=True, filename=f"q_rules_2/quantum_BATADAL_rule_rc_4.pdf")
        i = i + 1
    ...
    plt.grid()
    plt.savefig("q_rules_2/roc_curve_rc_4.png", dpi=300, bbox_inches='tight')